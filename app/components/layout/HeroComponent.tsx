  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center items-center w-full pointer-events-none mt-12 md:mt-0">
        ...
        <div className="flex flex-col items-start font-heading font-black text-[clamp(3rem,8vw,12rem)] leading-[0.9] tracking-tighter">
      ...
      {/* 右下角联系方式 */}
      <div className="relative z-10 flex justify-end items-center gap-3 w-full pb-4 pr-2 font-heading font-bold text-lg md:text-2xl lg:text-[2rem] tracking-wide">
        <MailIcon className="w-6 h-6 md:w-8 md:h-8 lg:w-12 lg:h-12 shrink-0" />
        <a 
          href={`mailto:${email}`}
          className="hover:text-neutral-400 transition-colors duration-300 cursor-pointer pointer-events-auto font-table"
        >
          {email}
        </a>
      </div>
